...
// Console obj
var output = {
    "welcome": " > Bienvenido a hundir la flota.  Utiliza el menú para empezar.",
    "not": " > Esta opción aún no está implementada.",
    "player1": " > ¿desea colocar los barcos o que se coloquen automaticamente?",
    "self": " > utilice el ratón y los botones para colocar los barcos.",
    "overlap": " > no se pueden superponer barcos.",
    "start": " > haga click con el ratón para atacar una casilla!",
...
function gameSetup(t) {
    $(t).off() && $(".two").off();
    $(".one").addClass("self").removeClass("one").text("Colocarlos yo (abajo)");
